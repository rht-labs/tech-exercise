...
1. Open the forecastle page, Navigate to CI & CD tab and Open the ArgoCD link or Search argocd in search bar and Open the ArgoCD link. You will automatically be logged in via KeyCloak SSO  
