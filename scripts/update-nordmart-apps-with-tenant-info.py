...
def fileNameChange(file_path, tenant_name):
    ...
    #Changes all files and folder which begins with "TENANT_NAME" to tenant_name in the "file_path" directory.
